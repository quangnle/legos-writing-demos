// Car Constants
const CAR_WIDTH = 10; // pixels
const CAR_LENGTH = CAR_WIDTH * 2; // pixels
const MAX_SPEED = 4.5; // pixels per frame
const MIN_SPEED = 0; // pixels per frame (khi giảm tốc)
const ACCELERATION_RATE = 0.08; // Tăng tốc độ bao nhiêu mỗi frame
const DECELERATION_RATE = 0.07; // Giảm tốc độ bao nhiêu mỗi frame (phanh)
...
const MAX_FRAMES_PER_GENERATION = 450; // Giới hạn thời gian cho mỗi thế hệ
...
// NEAT Constants
const INPUT_NODES = 2 + SENSOR_COUNT; // velocity magnitude, angle, sensor values
